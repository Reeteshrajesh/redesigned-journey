      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-700 mb-3">
            ...
            construed as financial, investment, or legal advice. Finscann does not provide personalized investment
            recommendations.
          </p>
          <ul className="text-sm text-gray-700 space-y-2 mb-3">
            ...
            <li className="flex gap-2">
              <span className="text-yellow-600 font-bold">•</span>
              <span>
                <strong>No Liability:</strong> Finscann and its authors are not liable for any financial losses
