...
import { trackSocialClick, trackWhatsAppClick, trackTelegramClick, trackContactClick } from '@/lib/analytics'
            ...
            <div className="pt-2">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  className="p-2.5 rounded-lg bg-gray-100 text-gray-600 hover:bg-black hover:text-white transition-all duration-200"
                  aria-label="Follow on X"
                >
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a
                  href="https://www.linkedin.com/company/finscann"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackSocialClick('linkedin', 'footer')}
                  className="p-2.5 rounded-lg bg-gray-100 text-gray-600 hover:bg-blue-700 hover:text-white transition-all duration-200"
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-5 border border-green-200">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg text-xs font-medium transition-colors"
                >
